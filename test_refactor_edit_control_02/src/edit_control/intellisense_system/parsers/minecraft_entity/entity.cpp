...
bool IntelliSense::Minecraft_Entity(std::wstring& Word, bool Use_Prop, bool Needs_Players, bool Needs_Single) {
    return Minecraft_Entity(Word, m_Syntax_Obj, Use_Prop, Needs_Players, Needs_Single);
}

bool IntelliSense::Minecraft_Entity(std::wstring& Word, Json& m_Syntax_Obj, bool Use_Prop, bool Needs_Players, bool Needs_Single) {
    if (Word.size() < 2) {
